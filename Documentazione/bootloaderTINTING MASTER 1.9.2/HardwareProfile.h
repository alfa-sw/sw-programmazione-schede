...
**
**      @brief   Platform-dependent symbol definitions
**
...
//#define USE_USB_BUS_SENSE_IO		//JP1 must be in R-U position to use this feature on this board
    ...
    /** LED ************************************************************/
    #define mInitAllLEDs()      LATA &= 0xFF00; TRISA &= 0xFF00;
    ...
    /** SWITCH *********************************************************/
    #define mInitSw_START()     TRISDbits.TRISD5=1
    #define mInitSw_ON_OFF()    TRISDbits.TRISD6=1
    #define mInitSw_STOP()      TRISDbits.TRISD7=1
    #define mInitSw_SEL()       TRISAbits.TRISA7=1
    #define mInitSw_RS()        TRISAbits.TRISA6=1


    #define mInitAllSwitches()  mInitSw_ON_OFF(); mInitSw_STOP(); mInitSw_START(); mInitSw_SEL(); mInitSw_RS();

    #define Sw_START            ~(PORTDbits.RD5)
    #define Sw_STOP             ~(PORTDbits.RD7)

    #define Sw_ON_OFF           ~(PORTDbits.RD6)
    #define Sw_SEL              ~(PORTAbits.RA7)
    #define Sw_RemoteStop       ~(PORTAbits.RA6)

    /** BUZZER *********************************************************/
    #define BUZZER            _LATA5
    #define mInitBuzzer()     BUZZER = 0; TRISAbits.TRISA5=0


  /** SILICON SERIAL NUMBER *********************************************************/
    #define HWSNOUT_LOW         _LATD3 = 0; TRISDbits.TRISD3=0
    #define HWSNOUT_HIGH        TRISDbits.TRISD3=1

    #define HWSNIN_PIN        PORTDbits.RD3

    #define HWSNIN_HIGH       (HWSNIN_PIN==(BIT)0x1u)
    #define HWSNIN_LOW        (HWSNIN_PIN==(BIT)0x0u)

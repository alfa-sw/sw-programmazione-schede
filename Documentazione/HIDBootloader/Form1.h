...
#define DEVICE_UNUSED_2             0x2B
#define DEVICE_UNUSED_3             0x2C
...
private: System::Windows::Forms::Button^  btn_unused_2;
private: System::Windows::Forms::Button^  btn_unused_3;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->btn_unused_2 = (gcnew System::Windows::Forms::Button());
			this->btn_unused_3 = (gcnew System::Windows::Forms::Button());
			...
			*/
			...
			// btn_unused_2
			// 
			this->btn_unused_2->Location = System::Drawing::Point(607, 535);
			this->btn_unused_2->Margin = System::Windows::Forms::Padding(4);
			this->btn_unused_2->Name = L"btn_unused_2";
			this->btn_unused_2->Size = System::Drawing::Size(143, 28);
			this->btn_unused_2->TabIndex = 80;
			this->btn_unused_2->Text = L"Unused 2";
			this->btn_unused_2->UseVisualStyleBackColor = true;
			this->btn_unused_2->Click += gcnew System::EventHandler(this, &Form1::btn_device_Click);
			// 
			// btn_unused_3
			// 
			this->btn_unused_3->Location = System::Drawing::Point(765, 535);
			this->btn_unused_3->Margin = System::Windows::Forms::Padding(4);
			this->btn_unused_3->Name = L"btn_unused_3";
			this->btn_unused_3->Size = System::Drawing::Size(143, 28);
			this->btn_unused_3->TabIndex = 81;
			this->btn_unused_3->Text = L"Unused 3";
			this->btn_unused_3->UseVisualStyleBackColor = true;
			this->btn_unused_3->Click += gcnew System::EventHandler(this, &Form1::btn_device_Click);
			// 
			// btn_unused_4
			// 
			...
			this->Controls->Add(this->btn_unused_3);
			this->Controls->Add(this->btn_unused_2);
	...
	private: void VerifyThreadStart()
	{
		...
		for (currentMemoryRegion = 0; currentMemoryRegion < memoryRegionsDetected; currentMemoryRegion++)
		{
			...
			while (AddressToRequest < (memoryRegions[currentMemoryRegion].Address + memoryRegions[currentMemoryRegion].Size))
			{
				...
				WriteFile(WriteHandleToMyDevice, myCommand.RawData, 65, &BytesWritten, 0);
				ErrorStatus = GetLastError();
				if (ErrorStatus == ERROR_SUCCESS) /* cioè non ci sono stati errori nella procedura di scrittura*/
				{
					packetsWritten++;
					AddressToRequest += (bytesPerPacket / bytesPerAddress);
					//Try to read a packet from the device
					ReadFile(ReadHandleToMyDevice, myResponse.RawData, 65, &BytesReceived, 0); //Shouldn't really do this.  Becomes infinite blocking function if it can't successfully write, for example, because the USB firmware on the microcontroller never sets the UOWN bit for the OUT endpoint.
					ErrorStatus = GetLastError();
					if (ErrorStatus == ERROR_SUCCESS) // Se il pacchetto è stato letto correttamente
					{
			...
			case VERIFY_SUCCESS:
				...
				if (ProgramThreadResults != PROGRAM_IDLE)
				{
					...
					if (deviceID == DEVICE_MAB)
						...
						static_cast<System::Int32>(static_cast<System::Byte>(0)));
					else if (deviceID == DEVICE_UNUSED_2)
						this->btn_unused_2->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(0)), static_cast<System::Int32>(static_cast<System::Byte>(200)),
						static_cast<System::Int32>(static_cast<System::Byte>(0)));
					else if (deviceID == DEVICE_UNUSED_3)
						this->btn_unused_3->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(0)), static_cast<System::Int32>(static_cast<System::Byte>(200)),
						static_cast<System::Int32>(static_cast<System::Byte>(0)));
...
//			DEBUG_OUT("Another device already selected");
		...
		if (origin->Name == "btn_MAB") {
			...
			if (Enable_Functions != 7)
				Enable_Functions = 0;
			ENABLE_PRINT();
			PRINT_STATUS("Selected target device is now MAB.");
		}
		...
		else if (origin->Name == "btn_unused_2") {
			deviceID = DEVICE_UNUSED_2;
			if (Enable_Functions != 7)
				Enable_Functions = 0;
			ENABLE_PRINT();
			PRINT_STATUS("Selected target device is now Unused 2.");
		}

		else if (origin->Name == "btn_unused_3") {
			deviceID = DEVICE_UNUSED_3;
			ENABLE_PRINT();
			PRINT_STATUS("Selected target device is now Unused 3.");
			if (Enable_Functions != 7) {			
				if (Enable_Functions == 1)
					Enable_Functions = 3;
				else 
					Enable_Functions = 0;
			}
